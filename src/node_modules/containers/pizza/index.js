...
class Pizza extends Component {
    ...
    renderPizza(pizza, index) {
        ...
        const shortDeacription = pizza.description.length   >  70 ?`${R.take(70, pizza.description)} ...` : pizza.description
        return (
            <div className='col-sm-4 col-lg-4 col-md-4 book-list' key={index}>
                <div className='thumbnail'>
                    ...
                    <div
                        ...
                        <p className='text-muted'>{shortDeacription}</p>
                        <p><h4 className='pull-right'>{pizza.price} руб.</h4></p>
