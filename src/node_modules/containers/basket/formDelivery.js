    ...
    render() {
        return (<div>
            ...
            <div style={{ width: 600, marginLeft: 'auto', marginRight: 'auto' }}>
                <form>
                    <TextField hintText="Розарио" underlineFocusStyle = {{textDecorationColor:'green'}}  underlineStyle={this.state.name === '' ? style.underlineStyle : style.floatingLabelFocusStyle} fullWidth={true} id="name" value={this.state.name} onChange={(e) => this.handleNameChange(e)} />
                    ...
                    <TextField hintText="Email" style={style} fullWidth={true} id="email" underlineStyle={this.state.email === '' ? style.underlineStyle : style.floatingLabelFocusStyle}  value={this.state.email} onChange={(e) => this.handleEmailChange(e)} />
                    <TextField hintText="Телефон" style={style} id="phone" underlineStyle={this.state.phone === '' ? style.underlineStyle : style.floatingLabelFocusStyle}   fullWidth={true} value={this.state.phone}  onChange={(e) => this.handlePhoneChange(e)} />
                    <TextField hintText="Пожелания" style={style} fullWidth={true} name="message" id="message" value={this.state.message} onChange={(e) => this.handleMessageChange(e)}  />
                    <br />
