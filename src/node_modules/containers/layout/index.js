    ...
    render() {
        return <MuiThemeProvider>
            <div>
                <AppBar
                    title={<TimeWork />}
                    titleStyle={{ marginLeft: '20%', fontSize: 16, color: 'green' }}
                    children={(
                        <img
                            style={styles.logo}
                ...
                <Drawer open={this.state.open} docked={true} width={200} containerStyle={{ top: 120 }}>
                    <ListItem
                        onClick={() => browserHistory.push('/')}
                        leftIcon={<Icon icon={ic_local_pizza} size={32} style={{ color: 'green' }} />}
                        primaryText='Меню'
                    ...
                    <ListItem
                        ...
                        leftIcon={<Icon icon={ic_person_pin} size={32} style={{ color: 'green' }} />}
                        primaryText='О нас'
                        innerDivStyle={{ paddingLeft: '64px', paddingBottom: '14px', fontSize: '14px', lineHeight: '18px', color: '#283741', textTransform: 'uppercase' }}
                    />
                    <ListItem
                        onClick={() => browserHistory.push('/news')}
                        leftIcon={<Icon icon={ic_event_available} size={32} style={{ color: 'green' }} />}
                        primaryText='Новости'
                        innerDivStyle={{ paddingLeft: '64px', paddingBottom: '14px', fontSize: '14px', lineHeight: '18px', color: '#283741', textTransform: 'uppercase' }}
                    />
                    <ListItem
                        onClick={() => browserHistory.push('/events')}
                        leftIcon={<Icon icon={calendar} size={32} style={{ color: 'green' }} />}
                        primaryText='Мероприятия'
                        innerDivStyle={{ paddingLeft: '64px', paddingBottom: '14px', fontSize: '14px', lineHeight: '18px', color: '#283741', textTransform: 'uppercase' }}
                    />
                    <ListItem
                        onClick={() => browserHistory.push('/reviews')}
                        leftIcon={<Icon icon={fileText2} size={32} style={{ color: 'green' }} />}
                        primaryText='Отзывы'
                        innerDivStyle={{ paddingLeft: '64px', paddingBottom: '14px', fontSize: '14px', lineHeight: '18px', color: '#283741', textTransform: 'uppercase' }}
                    />
                    <ListItem
                        onClick={() => browserHistory.push('/shares')}
                        leftIcon={<Icon icon={bell} size={32} style={{ color: 'green' }} />}
                        primaryText='Акции'
                        innerDivStyle={{ paddingLeft: '64px', paddingBottom: '14px', fontSize: '14px', lineHeight: '18px', color: '#283741', textTransform: 'uppercase' }}
                    />
                    <ListItem
                        onClick={() => browserHistory.push('/contact')}
                        leftIcon={<Icon icon={ic_phone_in_talk} size={32} style={{ color: 'green' }} />}
                    ...
                    <div className='container'>
                        <div className='row'>
                            <div className='col-md-3 pull-right'>
                                {this.props.location.pathname !== '/basket' && !this.props.location.pathname !== '/admin' && <BasketCart />}
                            </div>
