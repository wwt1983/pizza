    ...
    render() {
        return <MuiThemeProvider>
            <div>
                <AppBar
                    title={<TimeWork />}
                    titleStyle={{ marginLeft: '15%', fontSize: 16 }}
                    children={(
                        <img
                            style={styles.logo}
                            src={'/uploads/mozzarella_logo.png'}
                    ...
                    style={styles.bar}
                />
                <Drawer open={this.state.open} docked={true} width={200} containerStyle={{ top: 64 }}>
                    <ListItem
                        onClick={() => browserHistory.push('/')}
