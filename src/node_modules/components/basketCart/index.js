...
class BasketCart extends Component {
    render() {
        var style = window.screen.availWidth > 1000 ? {width:230, marginTop: 68,  marginLeft: '80%', position: 'absolute'} : {width:230, zIndex: 2000, marginTop: 68,  marginLeft: '80%'}
                    ...
                    <div className="panel panel-default" style={style}>
                        <div className="panel-body">
                            ...
                            {totalPrice > 0 && (
                                ...
                                <span onClick={() => browserHistory.push('/basket')}  style={{display:'inlineBlock', verticalAlign:'bottom', cursor: 'pointer'}}>
                                        ...
                                        <path d="M0 0h24v24H0z" fill="none"/>
                                    </svg></span><span style={{display:'inlineBlock', verticalAlign:'top'}}>{totalPrice} руб.</span>
                                </div>
                            )}
